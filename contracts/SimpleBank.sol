...
contract SimpleBank {
    ...
    function enroll() public returns (bool){
      ...
      require(enrolled[msg.sender] == false, "Sender is already enrolled");
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender] == true, "Sender needs to be enrolled first");
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "Sender has insufficient funds");
